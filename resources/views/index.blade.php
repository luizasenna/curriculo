...
<head>
    ...
    <title>Home - Luiza Senna</title>
    <meta name="description" content="Desenvolvedora de Software - Web Developer">
...
<body id="page-top">
    <nav class="navbar navbar-light navbar-expand-lg fixed-top bg-secondary text-uppercase" id="mainNav">
        <div class="container"><a class="navbar-brand js-scroll-trigger" href="#page-top">Luiza Senna</a><button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right text-uppercase bg-primary text-white rounded" aria-controls="navbarResponsive"
    ...
    <header class="masthead bg-primary text-white text-center" style="background-color: #F4F4ED;color: #2c3e50;">
        <div class="container"><img class="img-fluid d-block mx-auto mb-5" src="assets/img/profile.png">
            <h1 class="text-secondary">Luiza Senna</h1>
            <hr class="star-light">
            <h2 class="text-secondary font-weight-light mb-0">Multi-Skilled Web Developer</h2>
        </div><a class="btn btn-outline-light bg-secondary btn-xl" role="button" href="#"><i class="fa fa-download mr-2"></i><span>Laravel</span></a><a class="btn btn-outline-light bg-secondary btn-xl" role="button" href="#"><i class="fa fa-download mr-2"></i><span>JavaScript</span></a>
        <a
            class="btn btn-outline-light bg-secondary btn-xl" role="button" href="#"><i class="fa fa-download mr-2"></i><span>PHP</span></a><a class="btn btn-outline-light bg-secondary btn-xl" role="button" href="#"><i class="fa fa-download mr-2"></i><span>MySQL</span></a><a class="btn btn-outline-light bg-secondary btn-xl" role="button"
                href="#"><i class="fa fa-download mr-2"></i><span>Agile</span></a><a class="btn btn-outline-light bg-secondary btn-xl" role="button" href="#"><i class="fa fa-download mr-2"></i><span>PHP</span></a></header>
    <section id="about" class="bg-primary text-white mb-0">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 offset-lg-0">
                    <p class="lead text-secondary">Olá! Sou uma Desenvolvedora de Software Web Senior, com uma década de experiência no mercado. Trabalho especialmente com o framework Laravel e Wordpress utilizando métodos ágeis, mas aprendo com muita facilidades novas tecnologias.Tenho
                        experiência com gerenciamento e criação de fluxos com grandes massas de dados utilizando Pentaho Data Integration, gerenciamento de pequenos times como Scrum Master e desenvolvimentos de web apps e landing pages.</p>
                </div>
            </div>
            <div class="text-center mt-4"><a class="btn btn-outline-light text-secondary btn-xl" role="button" href="#"><i class="fa fa-download mr-2"></i><span>Download Now!</span></a></div>
        </div>
    </section>
    <section id="contact">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-5 mb-lg-0">
                    ...
                    <ul class="list-inline">
                        <li class="list-inline-item"><a class="btn btn-outline-light btn-social text-center rounded-circle" role="button" href="#"><i class="fa fa-github fa-fw"></i></a></li>
                        <li class="list-inline-item"><a class="btn btn-outline-light btn-social text-center rounded-circle" role="button" href="#"><i class="fa fa-linkedin-square fa-fw"></i></a></li>
                        <li class="list-inline-item"><a class="btn btn-outline-light btn-social text-center rounded-circle" role="button" href="#"><i class="fa fa-envelope fa-fw"></i></a></li>
                        <li class="list-inline-item"><a class="btn btn-outline-light btn-social text-center rounded-circle" role="button" href="#"><i class="fa fa-medium fa-fw"></i></a></li>
                    </ul>
                </div>
                <div class="col-md-4">
    ...
    <div class="copyright py-4 text-center text-white">
        <div class="container"><small>Copyright ©&nbsp;Luiza Senna 2020</small></div>
    </div>
